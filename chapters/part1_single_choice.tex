...
\nopagebreak
\begin{explainbox}{B}
\textbf{Concept \& Rationale:} Based on the discrete logarithm problem over elliptic curves, ECC delivers equivalent cryptographic security with much smaller key sizes (e.g., 256-bit ECC roughly equivalent to 3072-bit RSA), resulting in faster computations and lower bandwidth/memory footprints.
\end{explainbox}
