...
"""
Generates Part 1: 420 Single Choice questions (Q1 to Q420) across all 11 chapters.
Outputs to data/part1_single.json
"""
import json
import os
import sys
...
CHAPTER_TITLES = {
    ...
    7: "Firewall IPS",
    8: "Firewall User Management Technologies",
...
def create_part1():
    ...
    def q(ch, topic, stem, options, ans, exp):
        qid = len(questions) + 1
        questions.append({
            "id": qid,
            "chapter_num": ch,
    ...
    # CHAPTER 1: Q1 - Q36 (36 questions)
    q(1, "CIA Triad - Confidentiality",
    ...
    q(1, "Security History - Communication Security Era",
    ...
    q(1, "Security History - 1990s Information Assurance",
    ...
    q(1, "Information Security Standards - ISO 27001 vs ISO 27002",
    ...
    q(1, "Information Security Standards - ISO 27002 Purpose",
    ...
    q(1, "Cybersecurity Classified Protection 2.0 - Levels",
    ...
    q(1, "Cybersecurity Classified Protection 2.0 - Level 3",
    ...
    q(1, "Advanced Persistent Threat (APT)",
    ...
    q(1, "Software-Defined Perimeter (SDP)",
    ...
    q(1, "Cybersecurity Legal Framework",
    ...
    q(1, "Defense-in-Depth Principle",
    ...
    q(1, "Classified Protection 2.0 - Technical Requirements",
    ...
    q(1, "Classified Protection 2.0 - Management Requirements",
    ...
    q(1, "Cyberspace Domain Characteristics",
    ...
    q(1, "Controllability Definition",
    ...
    q(1, "Ransomware Threat Mechanism",
    ...
    q(1, "Security Awareness Training",
    ...
    q(1, "National Cyberspace Sovereignty",
    ...
    q(1, "Defense in Depth - Identity Tier",
    ...
    q(1, "Information Security Management System (ISMS)",
    ...
    q(1, "Physical Security Importance",
    ...
    print(f"Loaded Chapter 1: {len(questions)} questions.")

    # CHAPTER 2: Network Basics (Q37 - Q80, 44 questions)
    # We will systematically add Q37 - Q80
    ch2_data = [
        ("OSI Model - Layer Count", "How many layers are defined in the Open Systems Interconnection (OSI) reference model?",
        ...
        ("OSI Model - Layer 3 PDU", "What is the Protocol Data Unit (PDU) called at Layer 3 (Network Layer) of the OSI model?",
        ...
        ("OSI vs TCP/IP Model Mapping", "Which OSI layers are consolidated into the single Application layer of the 4-layer TCP/IP model?",
        ...
        ("Ethernet Frame - Destination MAC Length", "In a standard Ethernet II frame, what is the length in bytes of the Destination MAC address field?",
        ...
        ("Ethernet Frame - EtherType for IPv4", "What is the hexadecimal EtherType value indicating that the payload of an Ethernet II frame is an IPv4 packet?",
        ...
        ("Ethernet Frame - EtherType for ARP", "Which EtherType value indicates an Address Resolution Protocol (ARP) frame?",
         ["0x0800", "0x0806", "0x86DD", "0x8847"], "B",
         "EtherType 0x0806 is dedicated to the Address Resolution Protocol (ARP)."),
        ("Ethernet Frame - MTU", "What is the standard default Maximum Transmission Unit (MTU) size for an Ethernet interface payload?",
        ...
        ("IPv4 Header - Minimum Size", "What is the minimum length of an IPv4 packet header when no optional fields are included?",
        ...
        ("IPv4 Header - TTL Field Purpose", "What is the primary function of the Time to Live (TTL) field in an IPv4 header?",
        ...
        ("IPv4 Header - Protocol Field TCP", "In the IPv4 header, what protocol value in the 'Protocol' field designates TCP?",
         ["1", "6", "17", "47"], "B",
         "Common IP Protocol numbers: 1 = ICMP; 6 = TCP; 17 = UDP; 47 = GRE; 50 = ESP; 51 = AH; 89 = OSPF."),
        ("IPv4 Header - Protocol Field UDP", "Which value in the IPv4 Protocol field identifies the payload as a User Datagram Protocol (UDP) segment?",
         ["6", "17", "1", "88"], "B",
        ...
        ("IPv4 Addressing - RFC 1918 Private Ranges", "Which of the following IPv4 address blocks is designated as a private address space under RFC 1918?",
        ...
        ("IPv4 Addressing - Class C Private Range", "What is the valid RFC 1918 private IPv4 range for Class C addresses?",
        ...
        ("IPv4 Addressing - Loopback Range", "Which IPv4 address block is reserved by IANA for host internal loopback testing?",
        ...
        ("Subnetting - Usable Hosts in /27", "How many usable host IP addresses are available in an IPv4 subnet with a /27 prefix (mask 255.255.255.224)?",
         ["14", "30", "32", "62"], "B",
        ...
        ("Subnetting - Broadcast Address Calculation", "What is the directed broadcast address for the subnet 192.168.1.64/26?",
        ...
        ("Gratuitous ARP", "What is a primary purpose of transmitting a Gratuitous ARP packet?",
        ...
        ("Proxy ARP", "What is the function of Proxy ARP on a router or firewall interface?",
        ...
        ("ICMP - Layer", "At which OSI layer does the Internet Control Message Protocol (ICMP) logically operate, and how is it encapsulated?",
        ...
        ("ICMP - Traceroute", "Which ICMP message is generated by intermediate routers when their TTL counter reaches zero, enabling the 'tracert' / 'traceroute' command?",
        ...
        ("TCP - Operational Characteristics", "Which of the following is a key operational characteristic of Transmission Control Protocol (TCP)?",
        ...
        ("TCP 3-Way Handshake", "What is the correct sequence of TCP flag exchanges during connection establishment?",
        ...
        ("TCP 4-Way Handshake", "How many segments are typically exchanged to gracefully close a bidirectional TCP connection?",
        ...
        ("TCP TIME_WAIT State", "What is the primary reason the TCP active close endpoint remains in the TIME_WAIT state for 2 MSL (Maximum Segment Lifetime)?",
        ...
        ("TCP Flags - RST", "What is the function of the RST (Reset) flag in a TCP header?",
        ...
        ("UDP - Header Size", "What is the fixed header size of a standard User Datagram Protocol (UDP) segment?",
        ...
        ("UDP - Streaming Application", "Why is UDP preferred over TCP for real-time voice and video streaming (e.g., VoIP, video conferencing)?",
        ...
        ("DNS - Port and Transport", "Which transport protocol and port number are predominantly used by standard DNS client queries?",
        ...
        ("DNS - Record A Type", "Which DNS resource record type maps a fully qualified domain name (FQDN) to an IPv4 address?",
        ...
        ("HTTP vs HTTPS Ports", "What are the default standard TCP ports for unencrypted HTTP and encrypted HTTPS, respectively?",
        ...
        ("FTP - Port Architecture", "In traditional Active Mode File Transfer Protocol (FTP), which port is used for control commands and which for data transfer?",
        ...
        ("FTP Active Mode NAT Issue", "Why does Active FTP fail when the FTP client is located behind a standard NAT router/firewall?",
        ...
        ("Telnet vs SSH Security", "Why is SSH (TCP port 22) universally recommended over Telnet (TCP port 23) for device management?",
        ...
        ("DHCP - DORA Exchange", "What is the correct sequence of the four DHCP broadcast/unicast messages exchanged during dynamic host IP address allocation?",
        ...
        ("DHCP - Port Numbers", "Which UDP ports are utilized by DHCP servers and DHCP clients, respectively?",
        ...
        ("DHCP Relay", "When DHCP clients and the DHCP server reside in different IP subnets, which device feature must be configured on the local router/switch interface?",
        ...
        ("VLAN 802.1Q Header", "What is the size in bytes of the IEEE 802.1Q VLAN tag inserted into an Ethernet frame?",
    ...
    for item in ch2_data:
        q(2, item[0], item[1], item[2], item[3], item[4])

    print(f"Loaded Chapter 2: total {len(questions)} questions.")

    return questions

if __name__ == "__main__":
    qs = create_part1()
    print("Part 1 verification:", len(qs))
